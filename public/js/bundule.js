...
module.exports = {
  ...
  "_spec": "axios@^0.21.0",
  "_where": "/Users/code_max/var/veraDot",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
var showAlert = function showAlert(type, msg) {
  ...
  var markUp = "<div class=\" allert alert--".concat(type, "\">").concat(msg, "</div>");
...
var hideAlert = function hideAlert() {
  var el = document.querySelector('.allert');
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"register.js":[function(require,module,exports) {
"use strict";
...
var register = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, password, passwordConfirm, phone) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)('error', _context.t0.response.data.message); // console.log(err.response.data.message);
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"carReg.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.registerVehicle = exports.beforePayment = void 0;
...
var beforePayment = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Proceed to payment to complete vehicle registration");
              window.setTimeout(function () {
  ...
  return function beforePayment(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var registerVehicle = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(amount) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Vehicle registration Complete");
              window.setTimeout(function () {
                location.assign("/user/dashboard");
              }, 1500);
            }
  ...
  return function registerVehicle(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.registerVehicle = registerVehicle;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"complaint.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.layComplaint = void 0;
...
var layComplaint = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(complaintSubject, complaint) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Complaint sent successfully");
              window.setTimeout(function () {
                location.assign("/user/dashboard");
              }, 1500);
            }
  ...
  return function layComplaint(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.layComplaint = layComplaint;
...
var vehicleRegForm = document.querySelector('.car-reg');
var paymentForm = document.querySelector('.pay');
var complaintForm = document.querySelector('.complaint'); // Values
// delegations

if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = document.getElementById("login-input-user").value;
...
if (regForm) {
  regForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = document.getElementById("login-input-user").value;
    var email = document.getElementById("login-input-email").value;
    var password = document.getElementById("login-input-password").value;
    var passwordConfirm = document.getElementById("login-input-cpass").value;
    var phone = document.getElementById("login-input-phone").value;
    (0, _register.register)(name, email, password, passwordConfirm, phone);
  });
}

if (vehicleRegForm) {
  vehicleRegForm.addEventListener('submit', function (e) {
    e.preventDefault();
    ...
    data.append('proofOfOwnership', document.getElementById('owner').files[0].name);
    (0, _carReg.beforePayment)(data);
  });
}
...
if (paymentForm) {
  paymentForm.addEventListener('submit', function (e) {
    ...
    (0, _carReg.registerVehicle)(amount);
  });
}
...
//# sourceMappingURL=/bundule.js.map